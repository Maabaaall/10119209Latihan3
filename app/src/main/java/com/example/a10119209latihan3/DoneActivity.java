...
public class DoneActivity extends AppCompatActivity {
    ...
    public static final String ID_EXTRA_MSG_EXIT = "com.example.a10119209latihan3.MSG_EXIT";
    ...
    private void bindExtra(){
        ...
        name = intent.getStringExtra(com.example.a10119209latihan3.BiodataActivity.ID_EXTRA_MSG);
